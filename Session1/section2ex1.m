...
% Efficiency
% Accuracy
% Amount of epochs needed for an acceptable result
% Amount of datapoints needed

%% Exercise session 1 - section 2
% Comparing gradient descent and gradient descent with adaptive learning algorithms
...
%% Exercise session 1 - section 2
% Comparing gradient descent and gradient descent with momentum
% and gradient descent with momentum and adaptive learning rate
...
% Configuration:
alg1 = 'traingdm';% First training algorithm to use
alg2 = 'traingdx';% Second training algorithm to use
H = 50;% Number of neurons in the hidden layer
delta_epochs = [1,14,985];% Number of epochs to train in each step
epochs = cumsum(delta_epochs);
...
%% Exercise session 1 - section 2
% Comparing Fleycjer-Reeves conjugate gradient algorithm and Polak-Ribiere
...
% Configuration:
alg1 = 'traincgf';% First training algorithm to use
alg2 = 'traincgp';% Second training algorithm to use
H = 50;% Number of neurons in the hidden layer
delta_epochs = [1,14,985];% Number of epochs to train in each step
epochs = cumsum(delta_epochs);
